...
4. L'image est automatiquement :
   - ✅ Optimisée (redimensionnée si > 2048px)
...
| **Joystick ⬆️** | Agrandir | Poussez le joystick vers le haut |
| **Joystick ⬇️** | Réduire | Poussez le joystick vers le bas |
| **Joystick ➡️** | Augmenter opacité | Poussez le joystick vers la droite |
| **Joystick ⬅️** | Diminuer opacité | Poussez le joystick vers la gauche |
...
- 📐 Limitez la taille à **≤ 2048px** pour des performances optimales
...
- 🔲 **Image floue** → L'image était peut-être trop lourde ; utilisez ≤ 2048px
